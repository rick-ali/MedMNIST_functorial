...
from models.BaseModels import DDMNISTCNN
from utils.representations import C4xC4RegularRepresentation

class C4xC4RegularFunctor(pl.LightningModule):
    def __init__(self, lr=0.001, gamma=0.1, milestones=None, output_root=None, lambda_c=1.0, lambda_t=0.5, equivariant_layer_id=9, device='cuda'):
        super().__init__()
        ...
        # Select base model
        self.model = DDMNISTCNN(n_classes=100, n_channels=1, mnist_type='double', get_latent=True)
        ...
        #assert latent_dim % 16 == 0, "Latent dimension must be divisible by 16"
    ...
    def calculate_loss(self, batch, batch_idx, stage):
        ...
        losses = {
            ...
            f'{stage}_acc': self.get_accuracy(outputs1, labels1)
        }
